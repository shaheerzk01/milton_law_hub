...
export default function ComingSoon() {
    return (
      <div className="w-full min-h-screen bg-[#001489] p-4 overflow-y-auto">
        {/* Top Hero Section */}
        <div className="min-h-[45vh] w-full bg-white flex flex-col items-center justify-center text-[#001489] text-center px-4">
          <FaClock className="text-6xl sm:text-8xl text-[#001489] animate-pulse mb-4 drop-shadow-lg" />
          <h1 className="text-4xl sm:text-6xl font-bold tracking-wide">COMING SOON</h1>
          <p className="text-[#001489] text-sm sm:text-lg mt-2 max-w-md">
            We are working hard to bring you something amazing. Stay tuned!
          </p>
        </div>
  
        {/* Bottom Scrollable Content */}
        <div className="w-full bg-[#001489] px-6 py-8">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-white max-w-2xl mx-auto text-sm sm:text-base">
              Milton Hobbs is a distinguished international law firm providing sophisticated legal counsel across the UAE, France, and the Gulf region. We specialize in corporate, commercial, and international law, guided by a philosophy of{" "}
            ...
            <div className="flex flex-col sm:flex-row justify-center items-center space-y-4 sm:space-y-0 sm:space-x-4 w-full max-w-md mx-auto">
              <div className="flex flex-row items-center space-x-2 justify-center bg-white shadow-md p-2">
              ...
              <div className="flex flex-row items-center space-x-2 justify-center bg-white shadow-md p-2">
                ...
                <a
                  href="https://www.linkedin.com/company/milton-hobbs/"
                  target="_blank"
            ...
            {/* Google Map */}
            <div className="mt-8 w-full max-w-4xl p-4 bg-white shadow-lg mx-auto">
